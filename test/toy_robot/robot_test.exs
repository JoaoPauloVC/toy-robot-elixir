defmodule ToyRobot.RobotTest do
  ...
  describe "when the robot is facing north" do
    ...
    test "it moves north", %{robot: robot} do
  ...
  describe "when the robot is facing south" do
    ...
    test "it moves south", %{robot: robot} do
      robot = robot |> Robot.move()
      assert robot.north == -1
    end
  ...
  describe "when the robot is facing south, and it has moved north once" do
    setup do
  ...
  describe "when the robot is facing east" do
    ...
    test "it moves east", %{robot: robot} do
      robot = robot |> Robot.move()
      assert robot.east == 1
    end
  ...
  describe "when the robot is facing west" do
    ...
    test "it moves west", %{robot: robot} do
      robot = robot |> Robot.move()
      assert robot.east == -1
    end
